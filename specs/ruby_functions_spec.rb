...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_sphere()
    volume_sphere = radius_volume(10)
    assert_equal( 4186.67, volume_sphere)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    celcius_temperature = farenheit_celsius(100)
    assert_equal( 35, celcius_temperature)
  end
